...
// ============================================
function setup() {
    //Mine årsprøve variabler
    var leaveRoomPermission = false
    //Knapper
    var leaveRoom4Button
    var leaveRoom3Button = select("#arcadeDoorOpen")
    var leaveRoom2Button
    var leaveRoom1Button
...
function unlockDoor() {
    leaveRoomPermission = true
}

function escapeFromRoom(newRoom) {
    if (leaveRoomPermission == true) {
        shiftpage(newRoom)
        leaveRoomPermission = false
    } else {
        console.log("du må ikke gå ud")
        return
    }
}